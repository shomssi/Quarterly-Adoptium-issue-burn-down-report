...
- 
   When posting a legal/IP review alert, your comment MUST include a copy-paste-ready
  draft issue in exactly this format (fill in the bracketed values, keep the labels
  verbatim):
  **Suggested EMO issue title:** [short title describing the artwork/legal trigger]
  
  **Suggested issue body:**
  Project: adoptium/adoptium
  Triggering PR/issue: [link to the PR or issue that triggered this]
  ...
  **Suggested labels:** legal-review, ip
  ...
  Do not paraphrase this into a checklist or list of things the committer should
  include — output the fields above directly, already filled in, so the committer
  can copy them straight into a new GitLab issue at
  https://gitlab.eclipse.org/eclipsefdn/emo-team/emo without editing.
